#ifndef BLUEZ_SDBUS_HANDLER_H
#define BLUEZ_SDBUS_HANDLER_H
...
class BluezSdbusHandler : public IBleHandler
{
public:
    BluezSdbusHandler() = default;
    ~BluezSdbusHandler() = default;
    bool init() override;
    ...
    static void BluezSdbusHandler::onPropertiesChanged(sdbus::Signal& signal, BluezSdbusHandler* handler);

private:
    void onInterfacesAdded(const sdbus::Signal& signal);
